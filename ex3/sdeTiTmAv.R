sdeTiTmAv <- function(data, yTi,Ph){
  ...
  model$setParameter(a1 = c(init = 45, lb = 1E-5, ub = 1E5))
  model$setParameter(a2 = c(init = 1, lb = 1E-5, ub = 1E5))
  model$setParameter(a3 = c(init = 9, lb = 1E-5, ub = 1E5))
  model$setParameter(a4 = c(init = 2, lb = 1E-5, ub = 1E5))
  model$setParameter(a5 = c(init = 9, lb = 1E-5, ub = 1E5))  
  ##----------------------------------------------------------------    
